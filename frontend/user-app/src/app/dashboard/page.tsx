  ...
  const load = useCallback(async () => {
    ...
    try {
      const [w, i, e, list, tx, t, k] = await Promise.all([
        ...
        api.get<Paginated<Investment>>('/investments/?status=active&per_page=5'),
        api.get<Paginated<Transaction>>('/wallet/transactions/?per_page=8'),
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          hint={`${investments?.active_count ?? 0} active ${
            (investments?.active_count ?? 0) === 1 ? 'investment' : 'investments'
          }`}
          tone="accent"
        ...
        <StatCard
          ...
          hint={`${earnings?.network.total_downline ?? 0} in your network`}
          icon={<Users size={17} />}
        />
      </div>
      ...
      <div className="mt-8 grid gap-6 lg:grid-cols-3">
        ...
        <section className="lg:col-span-2">
          <div className="mb-3 flex items-center justify-between">
            ...
            <Link href="/investments" className="text-xs text-accent hover:underline">
          ...
          {investments?.upcoming_payouts.length ? (
            ...
            <EmptyState
              ...
              icon={<Coins size={26} />}
              action={<Link href="/wallet" className="btn-primary">Make a deposit</Link>}
            />
          )}
          ...
          {(tree?.tree?.length ?? 0) > 0 && (
            <>
              <div className="mb-3 mt-8 flex items-center justify-between">
                ...
                <Link href="/referrals" className="text-xs text-accent hover:underline">
        ...
        <aside className="space-y-6">
          ...
          <div className="card tex-right p-5">
            ...
            <Link href="/wallet" className="btn-ghost mt-4 w-full">
